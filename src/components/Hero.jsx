  ...
  return (
    <section className='text-black text-[18px]'>
        <div className='md:flex  justify-between items-center mx-5 my-10'>
            ...
            <img className='w-[50%] md:hidden mx-auto' src={image1} alt="" />
                <h1 className='md:text-[56px]  text-[20px] font-[700] mb-5'>Unlock Your Potential with Personalized Tutoring Solutions</h1>
            ...
            <img className='w-[50%] hidden md:block' src={image1} alt="" />
        </div>
        <div  className='md:flex justify-between items-center mx-5 my-10'>
<img className='w-[58%] mx-auto my-8 md:my-0 ' src={image} alt="" />
<div className=''>
