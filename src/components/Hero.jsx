...
const Hero = () => {
  ...
  return (
    <section className='text-black text-[18px]'>
        <div className='md:flex gap-20 items-center mx-5 my-10'>
            <div className=' font-[400]'>
            <img className='w-[60%] rounded-lg -rotate-6 my-5  md:hidden mx-auto  rounded-0' src={image1} alt="" />
              ...
              <NavLink to="/tutors" className=" bg-[#FF6F61]  text-[16px] text-white text-center w-[50%] py-[12px] rounded-[8px] hover:bg-white hover:text-[#ff6f61] border border-[#ff6f61] block my-5" >Find a Tutor</NavLink>
                <NavLink to="tutor-application" className="border text-[#FF6F61] border-[#FF6F61]  text-[16px] hover:bg-[#ff6f61] hover:text-white w-[50%] text-center py-[12px] rounded-[8px] block my-5" >Become a Tutor</NavLink>
 
              </div>
            </div>
            <img className='md:w-[40%] transform -rotate-3 rounded-md h-[70vh] hidden md:block' src={image1} alt="" />
        </div>
        <div  className='md:flex gap-20 items-center mx-5 my-10'>
<img className='w-[80%] mx-auto -rotate-3 rounded-lg my-8 md:my-0 ' src={image} alt="" />
<div className=''>
