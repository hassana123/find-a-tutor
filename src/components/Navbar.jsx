...
const Navbar = () => {
  ...
  return (
   <>
    <nav className='md:flex justify-between items-center py-3 w-[95%]  mx-auto  text-[16px]'>
...
<NavLink style={({isActive})=>{
        return isActive?{color:"#F13E3E"}:{}
      }} to="/find-a-tutor"  className=" hover:text-[#FF6F61] ">Find a Tutor</NavLink>
<NavLink style={({isActive})=>{
        return isActive?{color:"#F13E3E"}:{}
...
<NavLink style={({isActive})=>{
    ...
    {show &&       <div className='w-[65%] px-5 md:block bg-white shadow-lg py-20 absolute right-5  lg:hidden'>
...
<NavLink style={({isActive})=>{
        ...
        <div className='grid space-y-5 font-[400] text-center my-5'>
            <NavLink className="border w-[50%] hover:bg-[#FF6F61] hover:text-white border-[#FF6F61] px-[20px] py-[8px] rounded-[8px] text-[#ff6f61]" to="/login">Login</NavLink>
            <NavLink to="/sign-up" className="w-[50%] border-[#FF6F61] border  bg-[#FF6F61] hover:bg-transparent hover:text-[#FF6F61]  px-[20px] py-[8px] rounded-[8px] text-white">Sign Up</NavLink>
        </div>
       </div>}
